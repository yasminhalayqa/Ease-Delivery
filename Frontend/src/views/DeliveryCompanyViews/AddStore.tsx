...
export default function AddStore() {
    ...
    const { postData, loading } = usePostData('http://localhost:3000/users/store')
    ...
    return (
        <MiniDrawer>
            ...
            <Card className="mb-4">
                {/* <CardHeader title="إضافة شركة جديدة " sx={{
            ...
            <Card className="mb-4">
                <CardContent>
                    <Box sx={{ display: 'flex', justifyContent: 'start' }}>
                        ...
                        >{loading ? <CircularProgress color="secondary" /> : <>  إضافة شركة</>}
